...
public static class WebApplicationBidExtensions
{
    public static void MapBidEndpoints(this WebApplication app)
    {
        ...
        app.MapPost("/house/{houseId:int}/bids", async (int houseId, [FromBody] BidDataDto dto, IBidRepository repo) => 
        {   
        ...
        }).ProducesValidationProblem().ProducesProblem(400).Produces<BidDataDto>(StatusCodes.Status201Created);
    }
}